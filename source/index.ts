...
const schema: JSONSchema6 = {
    ...
    properties: {
        ...
        token_endpoint: {
            ...
            maxLength: 2048,
            description:
                "URL of the OP's OAuth 2.0 Token Endpoint. This is REQUIRED "
        ...
        jwks_uri: {
            ...
            maxLength: 2048,
            description:
                "URL of the OP's JSON Web Key Set document. This contains the "
        ...
        scopes_supported: {
            ...
            description:
                "A list of the OAuth 2.0 scope values that this server "
        ...
        response_modes_supported: {
            ...
            description:
                "A list of the OAuth 2.0 response_mode values that this OP "
        ...
        grant_types_supported: {
            ...
            description:
                "A list of the OAuth 2.0 Grant Type values that this OP "
        ...
        acr_values_supported: {
            ...
            description:
                "A list of the Authentication Context Class References that "
                + "this OP supports.",
        },
        subject_types_supported: {
            type: "array",
        ...
        id_token_signing_alg_values_supported: {
            ...
            description:
                "A list of the JWS signing algorithms (alg values) supported "
        ...
        token_endpoint_auth_methods_supported: {
            ...
            description:
                "A list of Client Authentication methods supported by this "
        ...
        display_values_supported: {
            ...
            description:
                "A list of the display parameter values that the OpenID "
        ...
        claims_supported: {
            ...
            description:
                "A list of the Claim Names of the Claims that the OpenID "
        ...
        claims_parameter_supported: {
            ...
            default: false,
            description:
                "Whether the OP supports use of the claims parameter, with "
